...
la inacción colectiva (ver evidencia fotográfica en el Anexo \ref{anexo:aeiou}, Fig. \ref{fig:evidencia_terreno}).
...
\begin{figure}[H]
	...
	\caption{Voluntarios realizando limpieza en playa. Fuente: \parencite{img_voluntarios}.}
	\label{fig:evidencia_terreno}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{img/2.jpg}
	\caption{Costa chilena con acumulación de residuos. Fuente: \parencite{img_microplasticos}.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{img/3.jpg}
	\caption{Residuos visibles sobre la arena. Fuente: \parencite{img_basura_arena}.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{img/4.jpg}
	\caption{Tipos de residuos: botellas, latas y envases plásticos. Fuente: \parencite{img_tipos_residuos}.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{img/5.jpg}
	\caption{Turista en playa chilena. Fuente: \parencite{img_turista}.}
\end{figure}
