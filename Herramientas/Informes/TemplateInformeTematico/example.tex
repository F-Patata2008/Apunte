...
% ------------------------------------------------------------------------------
% INTRODUCCIÓN
% Breve introducción de la herramienta empleada, su propósito general
% y por qué fue elegida para resolver las actividades.
% ------------------------------------------------------------------------------
\section{Introducción}

% ------------------------------------------------------------------------------
% OBJETIVOS
% Aquí puedes explicar los objetivos del laboratorio, qué se esperaba lograr y el enfoque con el que abordaste los problemas.
% ------------------------------------------------------------------------------
\section{Objetivos}

% ------------------------------------------------------------------------------
% DESARROLLO
% Explica en detalle las soluciones desarrolladas, cómo se enfrentaron los desafíos del laboratorio y qué características de la herramienta fueron más útiles. Se pueden incluir fragmentos de código, capturas de pantalla y descripciones claras de las etapas.
% ------------------------------------------------------------------------------
\section{Desarrollo}

% ------------------------------------------------------------------------------
% REFLEXIONES
% Aquí puedes reflexionar sobre los principales problemas que se presentaron, cómo los resolviste (o intentaste resolver), y qué aprendiste en el proceso.
% ------------------------------------------------------------------------------
\section{Reflexiones}

% ------------------------------------------------------------------------------
% CONCLUSIONES
% Síntesis de los resultados obtenidos, el valor de la herramienta utilizada y cómo se cumplió con los objetivos iniciales.
% ------------------------------------------------------------------------------
\section{Conclusiones}

% ------------------------------------------------------------------------------
% ANEXOS
% Capturas de pantalla, fragmentos de código adicionales, y cualquier otro material de apoyo que fortalezca lo descrito en el informe.
% ------------------------------------------------------------------------------
\section{Anexos}

% ------------------------------------------------------------------------------
% DE AQUÍ PARA ABAJO SE TIENE QUE BORRAR TODO.
% YA QUE SON EJEMPLOS DE FUNCIONALIDADES DE LATEX QUE LE PUEDEN SERVIR
% ------------------------------------------------------------------------------
