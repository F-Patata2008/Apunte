...
\subsection{Cotizaciones Ingredientes}
    %\subsubsection{Masa Prehecha}
        \begin{figure}[h]
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth ]{palaci} % Image for Chica
                \caption{Palacio de las Empanadas}
                \label{fig:palacio}
            \end{subfigure}
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{kosa} % Image for Mediana
    ...
    %\subsubsection{Huevos}
        %\begin{figure}[h]
            \begin{subfigure}{0.35\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{donhuevo} % Image for Chica
                \caption{El Don Huevo}
                \label{fig:don_huevo}
            \end{subfigure}
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{montan1} % Image for Mediana
    ...
    %\subsubsection{Camaron}
        %\begin{figure}[h]
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{gk} % Image for Chica
                \caption{Distribuidora GK}
                \label{fig:distribuidora_gk}
            \end{subfigure}
            \begin{subfigure}{0.35\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{oceanic} % Image for Mediana
    ...
    %\subsubsection{Carne Molida}
        %\begin{figure}[h]
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{central} % Image for Chica
                \caption{Central Mayorista}
                \label{fig:central_mayorista}
            \end{subfigure}
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{paiquito} % Image for Mediana
                \caption{Paiquito}
                \label{fig:unimarc}
            \end{subfigure}
    ...
    %\subsubsection{Queso}
        %\begin{figure}[h]
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{santiago} % Image for Chica
                \caption{Distribuidora Santiago}
                \label{fig:distribuidora_santiago}
            \end{subfigure}
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{nueva} % Image for Mediana
    ...
    %\subsubsection{Cebolla}
        \begin{figure}[h]
            \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{nat} % Image for Chica
                \caption{Santiago Natural Foods}
                \label{fig:santiago_natural_foods}
            \end{subfigure}
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{fres} % Image for Mediana
    ...
    %\subsubsection{Aceite}
        %\begin{figure}[h]
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{prosud} % Image for Chica
                \caption{ProsudMarket}
                \label{fig:prosudmarket}
            \end{subfigure}
            \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[width=0.9\linewidth]{aceite} % Image for Mediana
                \caption{Central Mayorista}
