...
\section{01/09 - }
\subsection{Godell}
\textbf{P.D.: Que hay infinitos números primos}
\textbf{D:} Supongamos que hay una cnatidad finita de números primos, dígamos $p_1$, $p_2$, ..., $p_k$, $k N$
Sea
\[M=p_1 \cdot p_2 \cdot p_3 \cdot ... \cdot p_k + 1\]
\[M \neq p_i , \forall \{1, ..., k\} (M no es primo) \]

¿$p_1$ divide a $M$? $\rightarrow$ resto 1 $\times$

¿$p_2$ divide a $M$? $\rightarrow$ resto 1, No
