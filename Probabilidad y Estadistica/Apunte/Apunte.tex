...
\section{05/09 - Ejercicios de Probabilidad Clásica}
...
\section{22/09 - Repaso y Fechas Importantes}
\subsection{Notas de la Clase}
\begin{itemize}
	\item \textbf{Prueba de Probabilidad (sin P. Condicional):} Lunes 29 de Julio.
	\item \textbf{Entrega de Guía:} Lunes 29 de Julio.
	\item \textbf{Inicio de Probabilidad Condicional:} Miércoles 24 de Julio.
	\item \textbf{Controles:} El promedio de los controles reemplazará la peor nota de prueba.
\end{itemize}
\newpage

\section{24/09 - Probabilidad Condicional}
...
\section{06/10 - Ejercicios de Probabilidad Condicional}
\subsection{Enunciados}
\begin{enumerate}
	...
	\item En la ciudad de San José, el 8\% de las personas gana más de \$1000 al mes, mientras que al 60\% le gusta el helado de chocolate. Asumiendo que ambos sucesos son independientes, ¿cuál es la probabilidad de que una persona seleccionada al azar en San José gane más de \$1000 al mes y le guste el helado de chocolate?
...
\begin{enumerate}
	...
	\item \textbf{Ingresos y helado:} \\
	      \textit{Solución:} Sean G="gana más de \$1000" y C="le gusta el helado de chocolate". Nos piden $P(G \cap C)$ y nos dicen que los eventos son independientes.
	      \begin{itemize}
		      \item \textbf{Datos:} $P(G)=0.08$ y $P(C)=0.60$.
		      \item \textbf{Fórmula para eventos independientes:} Si A y B son independientes, $P(A \cap B) = P(A) \cdot P(B)$.
	...
	\item \textbf{Estudiantes de Ingeniería:} \\
	      ...
	      \begin{itemize}
		      \item \textbf{Datos:} $P(R)=0.76$, $P(E)=0.45$ y $P(R \cap E) = 0.30$.
...
\section{08/10 - Teorema de Bayes y Problemas con Tablas}
\subsection{Enunciados}
\begin{enumerate}
	\setcounter{enumi}{3}
	\item En un acuario se tienen solo 2 especies de peces. El 40\% de los peces son de la especie azul y el 60\% son de la especie roja. De la especie azul, el 30\% son machos; mientras que, de la especie roja, el 40\% son hembras. Si se selecciona un pez al azar:
	      \begin{enumerate}
	      ...
	      \end{enumerate}
	\item En un consultorio, el 40\% de los pacientes fingen tener una enfermedad (para obtener un certificado médico). Además, el 10\% de los pacientes del consultorio son hombres. La probabilidad de que un paciente finja una enfermedad dado que es hombre es del 50\%. Calcule la probabilidad de que un paciente sea hombre, dado que finge una enfermedad.
	\item La Tabla \ref{tab:ResultadosExamen} muestra los resultados de 4 grupos de personas que rindieron el examen para obtener la licencia de conducir B.
	      ...
	      \begin{enumerate}
		      ...
		      \item ¿Cuál es la probabilidad de que una persona escogida al azar haya reprobado, si se sabe que rindió la prueba con el grupo 1?
	      \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textbf{Peces en el acuario (Teorema de Bayes):} \\
	      ...
	      \begin{itemize}
		      \item \textbf{Probabilidades dadas:}
		            $P(A)=0.4$, $P(R)=0.6$, $P(M|A)=0.3$, $P(H|R)=0.4$.
		      \item \textbf{Probabilidades deducidas:}
		            $P(H|A) = 1 - P(M|A) = 0.7$.
		            $P(M|R) = 1 - P(H|R) = 0.6$.
	      \end{itemize}
	      \begin{enumerate}
		      \item \textbf{Calcular $P(A|H)$:} "Prob. de que sea azul, dado que es hembra".
		            ...
		            Primero, calculamos la probabilidad total de ser hembra:
		            $P(H) = P(H|A)P(A) + P(H|R)P(R) = (0.7 \cdot 0.4) + (0.4 \cdot 0.6) = 0.28 + 0.24 = 0.52$.
		            \[ P(A|H) = \frac{0.28}{0.52} = \frac{28}{52} = \frac{7}{13} \]
		      \item \textbf{Calcular $P(R|M)$:} "Prob. de que sea roja, dado que es macho".
		            La probabilidad total de ser macho es $P(M) = 1 - P(H) = 1 - 0.52 = 0.48$.
		            Por Bayes: $P(R|M) = \frac{P(M|R)P(R)}{P(M)}$.
		            \[ P(R|M) = \frac{0.6 \cdot 0.6}{0.48} = \frac{0.36}{0.48} = \frac{36}{48} = \frac{3}{4} \]
	      \end{enumerate}
	...
	\item \textbf{Examen de conducir (Tabla de contingencia):} \\
	      \textit{Solución:} Primero, completamos la tabla con los totales.
	      \begin{center}
	      ...
	      \begin{enumerate}
		      \item \textbf{P(Aprobado | Grupo 3):} Miramos la fila "Grupo 3". 46 de 58 aprobaron.
		            \[ P(A|G3) = \frac{46}{58} = \frac{23}{29} \]
		      \item \textbf{P(Grupo 1 | Reprobado):} Miramos la columna "Reprobados". 5 de los 29 reprobados eran del Grupo 1.
		            \[ P(G1|R) = \frac{5}{29} \]
		      \item \textbf{P(Reprobado | Grupo 1):} Miramos la fila "Grupo 1". 5 de los 45 reprobaron.
		            \[ P(R|G1) = \frac{5}{45} = \frac{1}{9} \]
	      \end{enumerate}
\end{enumerate}
\newpage
