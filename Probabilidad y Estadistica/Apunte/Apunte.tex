...
\section{13/08 - }
%Esquema sobre si permuatcion, varaicion o Combinacion
...
%hacemos en el cuaderno ejercicos sobre la guía de combianciones/permtacuiosn y varaicion

\section{18/08 - Repaso Para Prueba}

\subsection{Ejercicios}
\begin{enumerate}
	\item Las cifras que componen un número $s_0$ 1, 2, 3, 4, 5. ¿Cuátos números diferentes de 5 cifras, menores de $54.000$, pueden formarse sin que se repita ninguna de las cifras?
\end{enumerate}
