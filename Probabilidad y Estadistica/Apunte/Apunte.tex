...
\subsubsection[Mediana (Me)]{Mediana ($M_e$):}
...
\subsubsection[Moda (Mo)]{Moda ($M_o$):} Es el dato o intervalo con la mayor frecuencia absoluta. La muestra puede ser:
\begin{itemize}
...
\subsubsection[Propiedades de sigma y sigma-cuadrado]{Propiedades de $\sigma$ y $\sigma^2$ (usando la definición con denominador $n$)}
\begin{center}
	\begin{enumerate}
...
\subsubsection[Propiedad 6: sigma-cuadrado = sigma si y solo si sigma=0 o sigma=1]{Propiedad 6: $\sigma^2 = \sigma \iff \sigma=0 \vee \sigma=1$}
